            ...
            <x-adminlte-datatable id="geofencesTable" :heads="$geofencesHeads">
                    @foreach ($geofences as $geofence)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ url('/geofences/'.$geofence->id) }}" class="btn btn-sm btn-secondary mr-1" data-toggle="tooltip" title="Ver Detalles">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ url('/geofences/'.$geofence->id.'/edit') }}" class="btn btn-sm btn-warning mr-1" data-toggle="tooltip" title="Editar">
